        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-heading">
                    <i class="fas fa-user"></i> Update User - <?php echo $data['post']['username']; ?>
                </div>
                <div class="panel-body">
                    <form action="<?php echo $_SESSION['mainUrl']; ?>/admin/users/update" method="POST">
                        <div class="row justify-content-center" style="margin-bottom:40px">
                            <div class="col-md-8 col-lg-8 col-lg-offset-2">
                                    <input type="hidden" name="user_id" class="form-control"
                                    value="<?php if(isset($data['post']['user_id'])) echo $data['post']['user_id']; ?>">
                                    <input type="hidden" name="reg_date" class="form-control"
                                    value="<?php if(isset($data['post']['reg_date'])) echo $data['post']['reg_date']; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    value="<?php if(isset($data['post']['user_address'])) echo $data['post']['user_address']; ?>">
                                </div>
                                <div class="form-group">
                                    <label>Level</label>
                ...
                <?php } else { ?>
                    <div class="panel-heading">
                        <i class="fas fa-user"></i> User Does Not Exist!!!
                    </div>
                <?php }?>
            </div>
        </div>
